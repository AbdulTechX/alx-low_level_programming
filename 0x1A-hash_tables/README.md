...
in this project i learned about hash tables and functions and how it been implemented in C.
# Tests

*  tests: Folder of test files. provide by Alx Software Engineering  School.

# Header File

*   hash_tables.h: Header file containing definition and prototype for all types and functions written for the projext.
