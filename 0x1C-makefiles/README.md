...
Helper Files 🙌
    ...
    main.c: Main C function that runs the function defined School.c. Provided by Alx School.

Header File 📁

    m.h: Header file defining the function prototype used in achool.c. Provided by Alx School.
